    ...
    <div class="container-fluid">
        ...
        <div class="row">
           <div class="col-xl-4 col-xxl-4 col-lg-6 col-md-6 col-sm-6">
                <div class="widget-stat card" style="cursor: pointer;" data-toggle="modal" data-target="#completedModal">
                    <div class="card-body p-4">
                        <div class="media ai-icon">
                            ...
                            <div class="media-body">
                                <h3 class="mb-0 text-black"><span class="counter ml-0">{{ $completedAppointments }}</span></h3>
           ...
           <div class="col-xl-4 col-xxl-4 col-lg-6 col-md-6 col-sm-6">
                <div class="widget-stat card" style="cursor: pointer;" data-toggle="modal" data-target="#totalModal">
                    <div class="card-body p-4">
                        <div class="media ai-icon">
                            <span class="mr-3 bgl-primary text-primary">
                            ...
                            <div class="media-body">
                                <h3 class="mb-0 text-black"><span class="counter ml-0">{{ $totalAppointments }}</span></h3>
           ...
           <div class="col-xl-4 col-xxl-4 col-lg-6 col-md-6 col-sm-6">
                <div class="widget-stat card" style="cursor: pointer;" data-toggle="modal" data-target="#patientsModal">
                    <div class="card-body p-4">
                        <div class="media ai-icon">
                            <span class="mr-3 bgl-primary text-primary">
                            ...
                            <div class="media-body">
                                <h3 class="mb-0 text-black"><span class="counter ml-0">{{ $totalPatients }}</span></h3>
...
<div class="modal fade" id="patientsModal" tabindex="-1" role="dialog" aria-labelledby="patientsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="patientsModalLabel">Total Patients</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <div class="container-fluid">
        <div class="form-head d-flex mb-3 align-items-start">
            <div class="mr-auto d-none d-lg-block">
                ...
                <div class="weight-600 font-w600 text-blue" style="font-size: 2rem"> @if (Auth::user()->usertype == 2)Dr. @endif{{ Auth::user()->firstname }}
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                data.forEach(function(appointment) {
                    ...
                    html += '<td>' + appointment.user.firstname + ' ' + appointment.user.lastname + '</td>';
                    html += '<td>' + (appointment.service ? appointment.service.name : 'Not available') + '</td>';
                    html += '<td>' + appointment.start_time + '</td>';
                    html += '</tr>';
                });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                data.forEach(function(appointment) {
                    ...
                    html += '<td>' + (appointment.service ? appointment.service.name : 'Not available') + '</td>';
                    html += '<td>' + appointment.start_time + '</td>';
                    html += '<td><span class="' + badgeClass + '">' + statusWord + '</span></td>';
                    html += '</tr>';
                });
